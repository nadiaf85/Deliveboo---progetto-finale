        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input value="{{old("name")}}" type="text" class="form-control col-12 col-sm-9 col-md-11 col-lg-9 ms_form_plate @error('name') is-invalid @enderror " id="name" name="name" placeholder="Titolo">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control col-12 col-sm-10 col-md-12 col-lg-10 ms_form_ingredients" id="ingredients" name="ingredients" placeholder="Descrizione" style="height: 100px">{{old('ingredients')}}</textarea>
                    </div>
                    @error('ingredients')
                        <div class="alert alert-danger">
                            {{$message}}
                ...
                <div class="mb-0 form-group">
                    ...
                    <input type="file" name="img" class="p-1 form-control col-9 col-sm-7 col-md-9 col-lg-6 ms_form_img @error('img') is-invalid @enderror ">
                </div>
                @error('img')
                <div class="mt-0 alert alert-danger">
                    {{$message}}
            ...
            <div class="col-0 col-md-6">
                <img class="img_create_logo" src="https://loghi-famosi.com/wp-content/uploads/2021/03/Deliveroo-Logo.png">
            </div>
        </div>
    </div>
@endsection